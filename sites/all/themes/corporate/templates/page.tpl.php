  ...
  <div class="inwrap">
    <div id="header-top">
        <div class="logo">
            <?php
              if ($logo){
                $dir = $dir_icon = explode("/",$logo);
                $name_file = explode(".",end($dir));
                $name_file[0] = $name_file[0]."_der";
                $name_file = implode(".",$name_file);
                $name_file_icon = "icon.png";
                array_pop($dir);
                array_push($dir,$name_file);
                array_pop($dir_icon);
                array_push($dir_icon,$name_file_icon);
                $logo_der = implode("/",$dir);
                $icon = implode("/",$dir_icon);
              }
            ?>
          <?php if ($logo): ?>
           <div id="logoimg">
          ...
          <?php endif; ?>
         <div class="sitename">
            <span class="titulo"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><?php print $site_name; ?></a></span>
            <div><img src="<?php print $icon;?>" height="20px" width="20px"/></div>
            <span class="descripcion"><?php print $site_slogan; ?></spans>
         </div>
         <div id="logoimg-der">
            <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><img src="<?php print $logo_der; ?>" alt="<?php print t('Home'); ?>" /></a>
         </div>
  ...
  <?php if ($page['footer_first'] || $page['footer_second'] || $page['footer_third']): ?>
   ...
   <?php endif; ?>
    ...
    <div id="bottom-wrapper" class="in<?php print (bool) $page['bottom_1'] + (bool) $page['bottom_2'] + (bool) $page['bottom_3'] + (bool) $page['bottom_4']; ?>">
          ...
          <div class="column A">
            <img style='float:left;width:7%' src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>"/>
            <div style='float:left;width:88%;margin-top: 3%;'><?php print render($page['bottom_1']); ?></div>
          </div>
          <?php endif; ?>
